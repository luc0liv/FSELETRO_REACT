...
export default function Categoria(props) {
    ...
    <Row>
        ...
        <ListGroupItem className=" bg-light bg-secondary" as={Link} href="/" to="/">Fogões</ListGroupItem>
        <ListGroupItem className="bg-light bg-secondary" as={Link} href="/" to="/">Geladeiras</ListGroupItem>
